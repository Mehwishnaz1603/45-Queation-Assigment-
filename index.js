...
let massage = "Do you like to read some books?";
...
let guest_list = ["Bisma", "Ayesha", "Kiran", "Kainat", "Neha"];
...
let guestlist = ["Arohi", "Kanwal", "Nimra", "Ahsan", "Hassan"];
...
let userNames = ["Admin", "Sana", "Ayesha", "Tuba", "Neha", "Kainat",];
...
let fvt_pizza = ["peproni", "Cheese", "BBQ Chicken", "Sicilian"];
...
let magicians_name = ["Harry Houdini", "Peter nelson", "Azur russel"];
function make_Great() {
